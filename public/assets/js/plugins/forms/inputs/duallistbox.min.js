...
!function (a, b, c, d) {
    ...
    function l(b, c) {
        if (b.settings.showFilterInputs) {
            ...
            var d = new RegExp(a.trim(b.elements["filterInput" + c].val()), "gi"), e = b.element.find("option"), f = b.element;
    ...
    function n(a) {
        ...
        b.sort(function (a, b) {
            var c = parseInt(a.getAttribute("data-sortindex")), d = parseInt(b.getAttribute("data-sortindex"));
    ...
    e.prototype = {
        init: function () {
            ...
            return this.settings.bootstrap2Compatible = a, a ? (this.container.removeClass("row").addClass("row-fluid bs2compatible"), this.container.find(".box1, .box2").removeClass("col-md-6").addClass("span6"), this.container.find(".clear1, .clear2").removeClass("btn-default btn-xs").addClass("btn-mini"), this.container.find("input, select").removeClass("form-control"), this.container.find(".btn").removeClass("btn-default"), this.container.find(".moveall > i, .move > i").removeClass("icon-arrow-right22").addClass("icon-arrow-right22"), this.container.find(".removeall > i, .remove > i").removeClass("icon-arrow-left22").addClass("icon-arrow-left22")) : (this.container.removeClass("row-fluid bs2compatible").addClass("row"), this.container.find(".box1, .box2").removeClass("span6").addClass("col-md-6"), this.container.find(".clear1, .clear2").removeClass("btn-mini").addClass("btn-default btn-xs"), this.container.find("input, select").addClass("form-control"), this.container.find(".btn").addClass("btn-default"), this.container.find(".moveall > i, .move > i").removeClass("icon-arrow-right22").addClass("icon-arrow-right22"), this.container.find(".removeall > i, .remove > i").removeClass("icon-arrow-left22").addClass("icon-arrow-left22")), b && k(this), this.element
