...
(function (f) {
    ...
    function s(a, b, d) {
        ...
        c; f++)1 == a.childNodes[f].nodeType && e.push(a.childNodes[f]);
        b = e[b];
    ...
    f.fn.dataTableExt.oApi.fnColReorder = function (a, b, d, e, g) {
        ...
        if (b != d)if (0 > b || b >= l)this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + b); else if (0 > d || d >= l)this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " +
            d); else {
            j = [];
            c = 0;
            for (h = l; c < h; c++)j[c] = c;
            ...
            var n = q(j);
            c = 0;
            for (h = a.aaSorting.length; c < h; c++)a.aaSorting[c][0] = n[a.aaSorting[c][0]];
            if (null !== a.aaSortingFixed) {
                c = 0;
                for (h = a.aaSortingFixed.length; c < h; c++)a.aaSortingFixed[c][0] = n[a.aaSortingFixed[c][0]]
            }
            c = 0;
            for (h = l; c < h; c++) {
                k = a.aoColumns[c];
            ...
            c = 0;
            for (h = l; c < h; c++)k = a.aoColumns[c], "number" == typeof k.mData ?
            ...
            if (a.aoColumns[b].bVisible) {
                ...
                m = null;
                for (c = d < b ? d : d + 1; null === m && c < l;)m = this.oApi._fnColumnIndexToVisible(a, c), c++;
            ...
            c = 0;
            for (h = l; c < h; c++)f(a.aoColumns[c].nTh).off("click.DT"), this.oApi._fnSortAttachListener(a, a.aoColumns[c].nTh, c);
    ...
    f.extend(i.prototype, {
        fnReset: function () {
            ...
            if (a.aaSorting) {
                ...
                b = 0;
                for (d = g.length; b < d; b++)e = g[b]._ColReorder_iOrigCol, a.aoSearchCols[e] = c[b], a.abVisCols[e] = g[b].bVisible, a.ColReorder.push(e)
            } else if (a.order) {
                for (b = 0; b < a.order.length; b++)a.order[b][0] = g[a.order[b][0]]._ColReorder_iOrigCol;
                c = f.extend(!0, [], a.columns);
                b = 0;
                for (d = g.length; b < d; b++)e = g[b]._ColReorder_iOrigCol, a.columns[e] = c[b], a.ColReorder.push(e)
            }
            ...
            for (var b = !1, d = this.s.mouse.toIndex, e = 1, f = this.s.aoTargets.length; e < f; e++)if (a.pageX < this.s.aoTargets[e - 1].x + (this.s.aoTargets[e].x - this.s.aoTargets[e - 1].x) / 2) {
            ...
            this.s.aoTargets.splice(0,
                this.s.aoTargets.length);
            this.s.aoTargets.push({x: f(this.s.dt.nTable).offset().left, to: 0});
            for (var b = 0, d = this.s.aoTargets[0].x, e = 0, g = a.length; e < g; e++)e != this.s.mouse.fromIndex && b++, a[e].bVisible && "none" !== a[e].nTh.style.display && (d += f(a[e].nTh).outerWidth(), this.s.aoTargets.push({
                x: d,
                to: b
            }));
            ...
            var a = "" !== this.s.dt.oScroll.sX ||
                "" !== this.s.dt.oScroll.sY, b = this.s.dt.aoColumns[this.s.mouse.targetIndex].nTh, d = b.parentNode, e = d.parentNode, g = e.parentNode, c = f(b).clone();
            ...
            this.dom.pointer = f("<div></div>").addClass("DTCR_pointer").css({
                position: "absolute",
                top: a ? f("div.dataTables_scroll", this.s.dt.nTableWrapper).offset().top :
    ...
    f.fn.dataTableExt.fnVersionCheck("1.10.8") ? f.fn.dataTableExt.aoFeatures.push({
        fnInit: function (a) {
            var b = a.oInstance;
