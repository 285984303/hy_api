...
(function (d) {
        ...
        action: function (a, b) {
            ...
            var c = function (e) {
                for (var g = 0, h = e.length; g < h; g++) {
                    ...
                    if (f.key)if (f.key === a)d(q).click(); else if (d.isPlainObject(f.key) &&
    ...
    m.instanceSelector = function (a, b) {
        ...
        var c = [], e = d.map(b,
            ...
            if (d.isArray(a))for (var f = 0, q = a.length; f < q; f++)g(a[f]); else"string" === typeof a ? -1 !== a.indexOf(",") ? g(a.split(",")) : (a = d.inArray(d.trim(a), e), -1 !== a && c.push(b[a].inst)) : "number" === typeof a && c.push(b[a].inst)
        };
        g(a);
        return c
    };
    m.buttonSelector = function (a, b) {
        for (var c = [], e = function (a, b, c) {
            ...
            if (d.isArray(a) || a instanceof d) {
                ...
                return a.idx
            }), c.push({inst: b, node: i[d.inArray(a, f)].node}); else if (-1 !==
                a.indexOf(":name")) {
