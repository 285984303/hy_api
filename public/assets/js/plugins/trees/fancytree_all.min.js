...
(function (factory) {
    ...
    !function (a, b, c, d) {
        ...
        function r(b, c) {
            var d, f, g, h;
            for (this.parent = b, this.tree = b.tree, this.ul = null, this.li = null, this.statusNodeType = null, this._isLoading = !1, this._error = null, this.data = {}, d = 0, f = F.length; f > d; d++)g = F[d], this[g] = c[g];
            c.data && a.extend(this.data, c.data);
            for (g in c)G[g] || a.isFunction(c[g]) || I[g] || (this.data[g] = c[g]);
            null == this.key ? this.tree.options.defaultKey ? (this.key = this.tree.options.defaultKey(this), e(this.key, "defaultKey() must return a unique key")) : this.key = "_" + v._nextNodeKey++ : this.key = "" + this.key, c.active && (e(null === this.tree.activeNode, "only one active node allowed"), this.tree.activeNode = this), c.selected && (this.tree.lastSelectedNode = this), h = c.children, h ? h.length ? this._setChildren(h) : this.children = this.lazy ? [] : null : this.children = null, this.tree._callHook("treeRegisterNode", this.tree, !0, this)
        }
        ...
        function s(b) {
            this.widget = b, this.$div = b.element, this.options = b.options, this.options && (a.isFunction(this.options.lazyload) && !a.isFunction(this.options.lazyLoad) && (this.options.lazyLoad = function () {
                return v.warn("The 'lazyload' event is deprecated since 2014-02-25. Use 'lazyLoad' (with uppercase L) instead."), b.options.lazyload.apply(this, arguments)
        ...
        var t, u, v = null, w = new RegExp(/\.|\//), x = /[&<>"'\/]/g, y = "$recursive_request", z = {
            ...
            2: "middle",
            3: "right"
        }, D = "active expanded focus folder hideCheckbox lazy selected unselectable".split(" "), E = {}, F = "expanded extraClasses folder hideCheckbox icon key lazy refKey selected statusNodeType title tooltip unselectable".split(" "), G = {}, H = {}, I = {
            active: !0,
            children: !0,
            data: !0,
            focus: !0
        };
        for (t = 0; t < D.length; t++)E[D[t]] = !0;
        for (t = 0; t < F.length; t++)u = F[t], G[u] = !0, u !== u.toLowerCase() && (H[u.toLowerCase()] = u);
        e(a.ui, "Fancytree requires jQuery UI (http://jqueryui.com)"), r.prototype = {
            _findDirectChild: function (a) {
                var b, c, d = this.children;
                if (d)if ("string" == typeof a) {
                    for (b = 0, c = d.length; c > b; b++)if (d[b].key === a)return d[b]
                } else {
                ...
                for (var b = 0, c = a.length; c > b; b++)this.children.push(new r(this, a[b]))
            }, addChildren: function (b, c) {
                var d, f, g, h = null, i = [];
                for (a.isPlainObject(b) && (b = [b]), this.children || (this.children = []), d = 0, f = b.length; f > d; d++)i.push(new r(this, b[d]));
                ...
                for (c in b)e = b[c], f[c] || a.isFunction(e) || (G[c] ? this[c] = e : this.data[c] = e);
                ...
                if (!e)return 0;
                if (d = e.length, a !== !1)for (b = 0, c = d; c > b; b++)d += e[b].countChildren();
                return d
            }, debug: function (a) {
                ...
                for (var c in b)G[c] ? this[c] = b[c] : "data" === c ? a.extend(this.data, b.data) : a.isFunction(b[c]) || I[c] || (this.data[c] = b[c]);
                ...
                if (this.parent) {
                    ...
                    for (a = 0, b = c.length - 1; b > a; a++)if (c[a] === this)return c[a + 1]
                }
                return null
            }, getParent: function () {
                return this.parent
                ...
                if (this.parent) {
                    var a, b, c = this.parent.children;
                    for (a = 1, b = c.length; b > a; a++)if (c[a] === this)return c[a - 1]
                }
                return null
                ...
                for (a = 0, b = c.length; b > a; a++)if (!c[a].expanded)return !1;
                return !0
            }, lazyLoad: function (a) {
                ...
                if (this !== b) {
                    if (this.parent ? i.isDescendantOf(this) && a.error("Cannot move a node to its own descendant") : a.error("Cannot move system root"), 1 === this.parent.children.length) {
                ...
                return e(this.isPagingNode(), "replaceWith() currently requires a paging status node"), c = this.tree._callHook("nodeLoadChildren", this, b), c.done(function (a) {
                    var b = g.children;
                    for (t = 0; t < b.length; t++)b[t].parent = d;
                ...
                var i, j, l, m, n = a.extend({
                    ...
                    topNode: null
                }, h), o = new a.Deferred, p = this, q = a(this.span).height(), r = a(n.scrollParent), s = n.scrollOfs.top || 0, t = n.scrollOfs.bottom || 0, u = r.height(), v = r.scrollTop(), w = r, x = r[0] === b, y = n.topNode || null, z = null;
                ...
                if (e) {
                    if (a = a || function (a, b) {
                            ...
                            }, e.sort(a), b)for (c = 0, d = e.length; d > c; c++)e[c].children && e[c].sortChildren(a, "$norender$");
                    "$norender$" !== b && this.render()
                }
            }, toDict: function (b, c) {
                var d, e, f, g = {}, h = this;
                if (a.each(F, function (a, b) {
                        (h[b] || h[b] === !1) && (g[b] = h[b])
                    }), a.isEmptyObject(this.data) || (g.data = a.extend({}, this.data), a.isEmptyObject(g.data) && delete g.data), c && c(g, h), b && this.hasChildren())for (g.children = [], d = 0, e = this.children.length; e > d; d++)f = this.children[d], f.isStatusNode() || g.children.push(f.toDict(!0, c));
                return g
            }, toggleClass: function (b, c) {
                var e, f, g = /\S+/g, h = b.match(g) || [], i = 0, j = !1, k = this[this.tree.statusClassPropName], l = " " + (this.extraClasses || "") + " ";
                ...
                if (f)for (c = 0, d = f.length; d > c && (e = f[c].visit(a, !0), e !== !1); c++);
                return e
            ...
            _makeHookContext: function (b, c, e) {
                ...
                var e = null, f = c.parent.children, g = null, h = function (a, b, c) {
                    ...
                    for (d = b + 1; g > d; d++)if (h(a, d, c) === !1)return !1;
                    return e = a.parent, e ? h(e, e.children.indexOf(a) + 1, c) : h(a, 0, c)
                };
                return b = "string" == typeof b ? q(b) : b, c = c || this.getFirstChild(), h(c.parent, f.indexOf(c), function (d) {
                    return d === e ? !1 : (e = e || d, a(d.span).is(":visible") ? b(d) && (g = d, g !== c) ? !1 : void 0 : void d.debug("quicksearch: skipping hidden node"))
                }), g
            ...
            nodeClick: function (a) {
                ...
                var c, d, e, f = a.node;
                if (f.parent)for (c = f.parent.children, d = 0, e = c.length; e > d; d++)c[d] !== f && c[d].expanded && this._callHook("nodeSetExpanded", c[d], !1, b)
                ...
                if (h || (f = this.getActiveNode() || this.getFirstChild(), f && (f.setFocus(), h = b.node = this.focusNode, h.debug("Keydown force focus on active node"))), j.quicksearch && m && /\w/.test(l) && !n.is(":input:enabled"))return d = (new Date).getTime(), d - i.lastQuicksearchTime > 500 && (i.lastQuicksearchTerm = ""), i.lastQuicksearchTime = d, i.lastQuicksearchTerm += l, c = i.findNextNode(i.lastQuicksearchTerm, i.getActiveNode()), c && c.setActive(), void g.preventDefault();
                switch (v.eventToString(g)) {
                    case"+":
                    case"=":
                ...
                return a.isFunction(c) && (c = c.call(h, {type: "source"}, b), e(!a.isFunction(c), "source callback must not return another function")), c.url && (i._requestId && i.warn("Recursive load request #" + j + " while #" + i._requestId + " is pending."), d = a.extend({}, b.options.ajax, c), i._requestId = j, d.debugDelay ? (f = d.debugDelay, a.isArray(f) && (f = f[0] + Math.random() * (f[1] - f[0])), i.warn("nodeLoadChildren waiting debugDelay " + Math.round(f) + " ms ..."), d.debugDelay = !1, g = a.Deferred(function (b) {
                    ...
                    var g, k;
                    if ("json" !== this.dataType && "jsonp" !== this.dataType || "string" != typeof d || a.error("Ajax request returned a string (did you get the JSON dataType wrong?)."), i._requestId && i._requestId > j)return void c.rejectWith(this, [y]);
                    ...
                    var c;
                    return a === y ? void i.warn("Ignored response for obsolete load request #" + j + " (expected #" + i._requestId + ")") : (a.node && a.error && a.message ? c = a : (c = h._makeHookContext(i, null, {
                        error: a,
                        args: Array.prototype.slice.call(arguments),
                ...
                f && (this.activeNode && this.activeNode.isDescendantOf(e) && this.activeNode.setActive(!1), this.focusNode && this.focusNode.isDescendantOf(e) && (this.focusNode = null),
                    this.nodeRemoveChildMarkup(b), c = a.extend({}, b), e.visit(function (a) {
                ...
                var i, j, k, l, m, n, o, p = b.node, q = b.tree, r = b.options, s = r.aria, t = !1, u = p.parent, v = !u, w = p.children, x = null;
                if (v || u.ul) {
                    if (e(v || u.ul, "parent UL must exist"), v || (p.li && (d || p.li.parentNode !== p.parent.ul) && (p.li.parentNode === p.parent.ul ? x = p.li.nextSibling : this.debug("Unlinking " + p + " (must be child of " + p.parent + ")"), this.nodeRemoveMarkup(b)), p.li ? this.nodeRenderStatus(b) : (t = !0, p.li = c.createElement("li"), p.li.ftnode = p, p.key && r.generateIds && (p.li.id = r.idPrefix + p.key), p.span = c.createElement("span"), p.span.className = "fancytree-node", s && a(p.span).attr("aria-labelledby", "ftal_" + r.idPrefix + p.key), p.li.appendChild(p.span), this.nodeRenderTitle(b), r.createNode && r.createNode.call(q, {type: "createNode"}, b)), r.renderNode && r.renderNode.call(q, {type: "renderNode"}, b)), w) {
                        if (v || p.expanded || f === !0) {
                            for (p.ul || (p.ul = c.createElement("ul"), (g !== !0 || h) && p.expanded || (p.ul.style.display = "none"), s && a(p.ul).attr("role", "group"), p.li ? p.li.appendChild(p.ul) : p.tree.$div.append(p.ul)), l = 0, m = w.length; m > l; l++)o = a.extend({}, b, {node: w[l]}), this.nodeRender(o, d, f, !1, !0);
                ...
                l && (k.push(j.node), d.activeNode === c && k.push(j.active), d.focusNode === c ? (k.push(j.focused), h && i.attr("aria-activedescendant", !0)) : h && i.removeAttr("aria-activedescendant"), c.expanded ? (k.push(j.expanded), h && i.attr("aria-expanded", !0)) : h && i.removeAttr("aria-expanded"), c.folder && k.push(j.folder), f !== !1 && k.push(j.hasChildren), g && k.push(j.lastsib), c.lazy && null == c.children && k.push(j.lazy), c.partload && k.push(j.partload), c.partsel && k.push(j.partsel), c.unselectable && k.push(j.unselectable), c._isLoading && k.push(j.loading), c._error && k.push(j.error), c.statusNodeType && k.push(j.statusNodePrefix + c.statusNodeType), c.selected ? (k.push(j.selected), h && i.attr("aria-selected", !0)) : h && i.attr("aria-selected", !1), c.extraClasses && k.push(c.extraClasses), f === !1 ? k.push(j.combinedExpanderPrefix + "n" + (g ? "l" : "")) : k.push(j.combinedExpanderPrefix + (c.expanded ? "e" : "c") + (c.lazy && null == c.children ? "d" : "") + (g ? "l" : "")), k.push(j.combinedIconPrefix + (c.expanded ? "e" : "c") + (c.folder ? "f" : "")), l.className = k.join(" "), c.li && (c.li.className = g ? j.lastsib : ""))
                ...
                d && (this.hasFocus() || (g.debug("nodeSetFocus: forcing container focus"), this._callHook("treeSetFocus", b, !0, {calledByNode: !0})), g.makeVisible({scrollIntoView: !1}), f.focusNode = g, f.options.titlesTabbable ? a(g.span).find(".fancytree-title").focus() : 0 === a(c.activeElement).closest(".fancytree-container").length && a(f.$container).focus(), this._triggerNodeEvent("focus", b), b.options.autoScroll && g.scrollIntoView(), this._callHook("nodeRenderStatus", b))
                ...
                if (g.rootNode.children && this.treeClear(b), c = c || this.options.source)"string" == typeof c && a.error("Not implemented"); else switch (d = h.data("type") || "html") {
                    case"html":
                ...
                return f = this.nodeLoadChildren(i, c).done(function () {
                    g.render(), 3 === b.options.selectMode && g.rootNode.fixSelection3FromEndNodes(), g.activeNode && g.options.activeVisible && g.activeNode.makeVisible(), g._triggerTreeEvent("init", null, {status: !0})
                }).fail(function () {
                    g.render(), g._triggerTreeEvent("init", null, {status: !1})
                })
            }, treeRegisterNode: function (a, b, c) {
            }, treeSetFocus: function (b, c, d) {
                c = c !== !1, c !== this.hasFocus() && (this._hasFocus = c, !c && this.focusNode ? this.focusNode.setFocus(!1) : !c || d && d.calledByNode || a(this.$container).focus(), this.$container.toggleClass("fancytree-treefocus", c), this._triggerTreeEvent(c ? "focusTree" : "blurTree"))
            }
            ...
            options: {
                ...
                this.tree = new s(this), this.$source = this.source || "json" === this.element.data("type") ? this.element : this.element.find(">ul:first");
                ...
                this._unbind(), c.$container.on("focusin" + d + " focusout" + d, function (a) {
                    var b = v.getNode(a), d = "focusin" === a.type;
                    ...
                    var d, e = v.getEventTarget(c), f = e.node, g = a.tree, h = g.phase;
                    if (!f)return !0;
                    d = g._makeHookContext(f, c);
                    try {
                        switch (g.phase = "userEvent", c.type) {
                            case"click":
                                return d.targetType = e.type, f.isPagingNode() ? g._triggerNodeEvent("clickPaging", d, c) === !0 : g._triggerNodeEvent("click", d, c) === !1 ? !1 : g._callHook("nodeClick", d);
                            case"dblclick":
        ...
        }), v = a.ui.fancytree, a.extend(a.ui.fancytree, {
            version: "2.18.0",
            ...
            getTree: function (b) {
                var c;
                return b instanceof s ? b : (b === d && (b = 0), "number" == typeof b ? b = a(".fancytree-container").eq(b) : "string" == typeof b ? b = a(b).eq(0) : b.selector !== d ? b = b.eq(0) : b.originalEvent !== d && (b = a(b.target)), b = b.closest(":ui-fancytree"), c = b.data("ui-fancytree") || b.data("fancytree"), c ? c.tree : null)
            },
            info: function (b) {
            ...
            eventToString: function (a) {
                ...
                return a.altKey && d.push("alt"), a.ctrlKey && d.push("ctrl"), a.metaKey && d.push("meta"), a.shiftKey && d.push("shift"), "click" === c || "dblclick" === c ? d.push(C[a.button] + c) : A[b] || d.push(B[b] || String.fromCharCode(b).toLowerCase()), d.join("+")
            },
            ...
            parseHtml: function (b) {
                ...
                return l.each(function () {
                    var l, o, p = a(this), q = p.find(">span:first", this), r = q.length ? null : p.find(">a:first"), s = {
                        tooltip: null,
                        data: {}
                    };
                    for (q.length ? s.title = q.html() : r && r.length ? (s.title = r.html(), s.data.href = r.attr("href"), s.data.target = r.attr("target"), s.tooltip = r.attr("title")) : (s.title = p.html(), h = s.title.search(/<ul/i), h >= 0 && (s.title = s.title.substring(0, h))), s.title = a.trim(s.title), g = 0, i = D.length; i > g; g++)s[D[g]] = d;
                    for (c = this.className.split(" "), f = [], g = 0, i = c.length; i > g; g++)e = c[g], E[e] ? s[e] = !0 : f.push(e);
                    if (s.extraClasses = f.join(" "), j = p.attr("title"), j && (s.tooltip = j), j = p.attr("id"), j && (s.key = j), l = n(p), l && !a.isEmptyObject(l)) {
                        for (o in H)l.hasOwnProperty(o) && (l[H[o]] = l[o], delete l[o]);
                        for (g = 0, i = F.length; i > g; g++)j = F[g], k = l[j], null != k && (delete l[j], s[j] = k);
                        a.extend(s.data, l)
                    }
    ...
    !function (a, b) {
        ...
        a.ui.fancytree._FancytreeClass.prototype.countSelected = function (a) {
            ...
            var b = this, c = a("span.fancytree-childcounter", b.span), d = b.tree.options.childcounter, e = b.countChildren(d.deep);
            ...
            nodeRenderTitle: function (b, c) {
                var d = b.node, e = b.options.childcounter, f = null == d.data.childCounter ? d.countChildren(e.deep) : +d.data.childCounter;
                this._superApply(arguments), !f && e.hideZeros || d.isExpanded() && e.hideExpanded || a("span.fancytree-icon", d.span).append(a("<span class='fancytree-childcounter'/>").text(f))
            },
    ...
    !function (a, b, c, d) {
        ...
        function f() {
            h || (a.ui.plugin.add("draggable", "connectToFancytree", {
                start: function (b, c) {
                    ...
                    var d, e, f, g = a(this).data("ui-draggable") || a(this).data("draggable"), h = c.helper.data("ftSourceNode") || null, i = c.helper.data("ftTargetNode") || null, j = a.ui.fancytree.getNode(b.target), k = h && h.tree.options.dnd;
                    ...
                    var d, e = a(this).data("ui-draggable") || a(this).data("draggable"), f = c.helper.data("ftSourceNode") || null, g = c.helper.data("ftTargetNode") || null, h = "mouseup" === b.type && 1 === b.which;
        ...
        var h = !1, i = "fancytree-drop-accept", j = "fancytree-drop-after", k = "fancytree-drop-before", l = "fancytree-drop-over", m = "fancytree-drop-reject", n = "fancytree-drop-target";
        a.ui.fancytree.registerExtension({
            name: "dnd",
            version: "0.3.0",
            options: {
            ...
            _setDndStatus: function (b, c, d, f, g) {
                var h = 0, o = "center", p = this._local, q = this.options.glyph || null, r = b ? a(b.span) : null, s = a(c.span);
                if (p.$dropMarker || (p.$dropMarker = a("<div id='fancytree-drop-marker'></div>").hide().css({"z-index": 1e3}).prependTo(a(this.$div).parent()), q && p.$dropMarker.addClass(q.map.dropMarker)), "after" === f || "before" === f || "over" === f) {
                    switch (f) {
                        case"before":
                            o = "top";
                            break;
                ...
                r && r.toggleClass(i, g === !0).toggleClass(m, g === !1), s.toggleClass(n, "after" === f || "before" === f || "over" === f).toggleClass(j, "after" === f).toggleClass(k, "before" === f).toggleClass(i, g === !0).toggleClass(m, g === !1), d.toggleClass(i, g === !0).toggleClass(m, g === !1)
            },
            _onDragEvent: function (b, e, f, g, h, i) {
                var j, k, l, m, n, o, p, q, r, s = this.options, t = s.dnd, u = this._makeHookContext(e, g, {
                    otherNode: f,
                    ui: h,
                    draggable: i
                }), v = null, w = this, x = a(e.span);
                switch (t.smartRevert && (i.options.revert = "invalid"), b) {
                    case"start":
                        ...
                        break;
                    case"enter":
                        r = t.preventRecursiveMoves && e.isDescendantOf(f) ? !1 : t.dragEnter ? t.dragEnter(e, u) : null, v = r ? a.isArray(r) ? {
                            ...
                            before: r === !0 || "before" === r,
                            after: r === !0 || "after" === r
                        } : !1, h.helper.data("enterResponse", v);
                        break;
                    case"over":
    ...
    !function (a, b, c, d) {
        ...
        a.ui.fancytree._FancytreeNodeClass.prototype.editStart = function () {
            ...
            return h.beforeEdit.call(d, {type: "beforeEdit"}, j) === !1 ? !1 : (a.ui.fancytree.assert(!f.currentNode, "recursive edit"), f.currentNode = this, f.eventData = j, e.widget._unbind(), a(c).on("mousedown.fancytree-edit", function (b) {
            ...
            var e, g = this, h = this.tree, i = h.ext.edit, j = i.eventData, k = h.options.edit, l = a(".fancytree-title", g.span), m = l.find("input.fancytree-edit-input");
            return k.trim && m.val(a.trim(m.val())), e = m.val(), j.dirty = e !== g.title, b === !1 ? j.save = !1 : j.isNew ? j.save = "" !== e : j.save = j.dirty && "" !== e, k.beforeClose.call(g, {type: "beforeClose"}, j) === !1 ? !1 : j.save && k.save.call(g, {type: "save"}, j) === !1 ? !1 : (m.removeClass("fancytree-edit-dirty").unbind(), a(c).off(".fancytree-edit"), j.save ? (g.setTitle(h.options.escapeTitles ? e : f(e)), g.setFocus()) : j.isNew ? (g.remove(), g = j.node = null, i.relatedNode.setFocus()) : (g.renderTitle(), g.setFocus()), i.eventData = null, i.currentNode = null, i.relatedNode = null, h.widget._bind(), a(h.$container).focus(), j.input = null, k.close.call(g, {type: "close"}, j), !0)
    ...
    !function (a, b, c, d) {
        ...
        a.ui.fancytree._FancytreeClass.prototype._applyFilterImpl = function (b, c, d) {
            var i, j, k, l, m, n = 0, o = this.options, p = o.escapeTitles, q = o.filter, r = "hide" === q.mode;
            return d = d || {}, i = !!d.leavesOnly && !c, "string" == typeof b && (j = q.fuzzy ? b.split("").reduce(function (a, b) {
                return a + "[^" + b + "]*" + b
            }) : e(b), l = new RegExp(".*" + j + ".*", "i"), m = new RegExp(b, "gi"), b = function (a) {
                var b, c = p ? a.title : f(a.title), d = !!l.test(c);
                return d && q.highlight && (b = p ? h(a.title) : c, a.titleWithHighlight = b.replace(m, function (a) {
                    return "<mark>" + a + "</mark>"
                })), d
            }), this.enableFilter = !0, this.lastFilterArgs = arguments, this.$div.addClass("fancytree-ext-filter"), r ? this.$div.addClass("fancytree-ext-filter-hide") : this.$div.addClass("fancytree-ext-filter-dimm"), this.visit(function (a) {
                delete a.match, delete a.titleWithHighlight, a.subMatchCount = 0
            }), k = this.getRootNode()._findDirectChild(g), k && k.remove(), this.visit(function (a) {
                if (!i || null == a.children) {
                    var e = b(a);
                    return "skip" === e ? (a.visit(function (a) {
                        a.match = !1
                    }, !0), "skip") : e && (n++, a.match = !0, a.visitParents(function (a) {
                        a.subMatchCount += 1, d.autoExpand && !a.expanded && (a.setExpanded(!0, {
                            noAnimation: !0,
                            noEvents: !0,
                            scrollIntoView: !1
                        }), a._filterAutoExpanded = !0)
                    }), c || "branch" === e) ? (a.visit(function (a) {
                        a.match = !0
                    }), d.autoExpand && !a.expanded && (a.setExpanded(!0, {
                        noAnimation: !0,
                        noEvents: !0,
                        scrollIntoView: !1
                    }), a._filterAutoExpanded = !0), "skip") : void 0
                }
            }), 0 === n && q.nodata && (k = q.nodata, a.isFunction(k) && (k = k()), k === !0 ? k = {} : "string" == typeof k && (k = {title: k}), k = a.extend({
                statusNodeType: "nodata",
                key: g,
                title: this.options.strings.noData
            }, k), this.getRootNode().addNode(k).match = !0), this.render(), n
        }, a.ui.fancytree._FancytreeClass.prototype.filterNodes = function (a, b) {
            return "boolean" == typeof b && (b = {leavesOnly: b}, this.warn("Fancytree.filterNodes() leavesOnly option is deprecated since 2.9.0 / 2015-04-19.")), this._applyFilterImpl(a, !1, b)
            ...
            var b, c = this.getRootNode()._findDirectChild(g), d = this.options.escapeTitles, e = this.options.enhanceTitle;
            c && c.remove(), this.visit(function (c) {
                c.match && (b = a(">span.fancytree-title", c.span), d ? b.text(c.title) : b.html(c.title), e && e({type: "enhanceTitle"}, {
                    node: c,
                    $title: b
    ...
    !function (a, b, c, d) {
            ...
            switch (b) {
                ...
                case h.DOWN:
                    for (c = g.parent(), d = e(c, g); ;) {
                        ...
                        if (!c.is(":hidden") && (i = f(c, d), i && i.find(":input").length))break
                    }
            }
            return i
        }
        ...
        a.ui.fancytree.registerExtension({
            ...
            nodeKeydown: function (b) {
                ...
                return c = j.is(":input:enabled") ? j.prop("type") : null, c && f.handleCursorKeys ? (d = i[c], d && a.inArray(h.which, d) >= 0 && (e = g(j, h.which), e && e.length) ? (e.find(":input:enabled").focus(), !1) : !0) : this._superApply(arguments)
            }
        })
    }(jQuery, window, document);
    ...
    !function (a, b, c, d) {
        ...
        function e(b, c, d, f, g) {
            var h, i, j, l, m = !1, n = [], o = [];
            for (d = d || [], g = g || a.Deferred(), h = 0, j = d.length; j > h; h++)i = d[h], l = b.getNodeByKey(i), l ? f && l.isUndefined() ? (m = !0, b.debug("_loadLazyNodes: " + l + " is lazy: loading..."), "expand" === f ? n.push(l.setExpanded()) : n.push(l.load())) : (b.debug("_loadLazyNodes: " + l + " already loaded."), l.setExpanded()) : (o.push(i), b.debug("_loadLazyNodes: " + l + " was not yet found."));
            return a.when.apply(a, n).always(function () {
                if (m && o.length > 0)e(b, c, o, f, g); else {
                    if (o.length)for (b.warn("_loadLazyNodes: could not load those keys: ", o), h = 0, j = o.length; j > h; h++)i = d[h], c._appendKey(k, d[h], !1);
                    g.resolve()
                }
            }), g
        }
            ...
            treeInit: function (c) {
                ...
                return i("auto" !== o.store && "cookie" !== o.store || f, "Missing required plugin for 'persist' extension: js.cookie.js or jquery.cookie.js"), n.cookiePrefix = o.cookiePrefix || "fancytree-" + g._id + "-", n.storeActive = o.types.indexOf(j) >= 0, n.storeExpanded = o.types.indexOf(k) >= 0, n.storeSelected = o.types.indexOf(m) >= 0, n.storeFocus = o.types.indexOf(l) >= 0, "cookie" !== o.store && b.localStorage ? n.localStorage = "local" === o.store ? b.localStorage : b.sessionStorage : n.localStorage = null, g.$div.bind("fancytreeinit", function (b) {
                    if (g._triggerTreeEvent("beforeRestore", null, {}) !== !1) {
                        ...
                        c = n._data(n.cookiePrefix + k), p = c && c.split(o.cookieDelimiter), f = n.storeExpanded ? e(g, n, p, o.expandLazy ? "expand" : !1, null) : (new a.Deferred).resolve(), f.done(function () {
                            if (n.storeSelected) {
    ...
    !function (a, b, c, d) {
        ...
        function h(b) {
            ...
            if (h && h.length > 1 && h[0] !== b)for (c = a.inArray(b, h), f = h[c - 1], e(f.tr); f.children && (d = f.children[f.children.length - 1], d.tr);)f = d; else f = g;
            return f
        }
        ...
        a.ui.fancytree.registerExtension({
            ...
            nodeRender: function (b, c, d, i, j) {
                var k, l, m, n, o, p, q, r, s = b.tree, t = b.node, u = b.options, v = !t.parent;
                if (j || (b.hasCollapsedParents = t.parent && !t.parent.expanded), !v)if (t.tr)c ? this.nodeRenderTitle(b) : this.nodeRenderStatus(b); else {
                    if (b.hasCollapsedParents && !d)return void t.debug("nodeRender ignored due to unrendered parent");
                    o = s.rowFragment.firstChild.cloneNode(!0), p = h(t), e(p), i === !0 && j ? o.style.display = "none" : d && b.hasCollapsedParents && (o.style.display = "none"), p.tr ? f(p.tr, o) : (e(!p.parent, "prev. row must have a tr, or is system root"), s.tbody.appendChild(o)), t.tr = o, t.key && u.generateIds && (t.tr.id = u.idPrefix + t.key), t.tr.ftnode = t, u.aria && a(t.tr).attr("aria-labelledby", "ftal_" + t.key), t.span = a("span.fancytree-node", t.tr).get(0), this.nodeRenderTitle(b), u.createNode && u.createNode.call(s, {type: "createNode"}, b)
                }
                if (u.renderNode && u.renderNode.call(s, {type: "renderNode"}, b), k = t.children, k && (v || d || t.expanded))for (m = 0, n = k.length; n > m; m++)r = a.extend({}, b, {node: k[m]}), r.hasCollapsedParents = r.hasCollapsedParents || !t.expanded, this.nodeRender(r, c, d, i, !0);
                k && !j && (q = t.tr || null, l = s.tbody.firstChild, t.visit(function (a) {
                    if (a.tr) {
                        if (a.parent.expanded || "none" === a.tr.style.display || (a.tr.style.display = "none", g(a, !1)), a.tr.previousSibling !== q) {
            ...
            nodeRenderTitle: function (b, c) {
                ...
                return e = this._superApply(arguments), f.isRootNode() ? e : (g.checkbox && !h && null != g.table.checkboxColumnIdx && (d = a("span.fancytree-checkbox", f.span), a(f.tr).find("td").eq(+g.table.checkboxColumnIdx).html(d)), this.nodeRenderStatus(b), h ? g.renderStatusColumns && g.renderStatusColumns.call(b.tree, {type: "renderStatusColumns"}, b) : g.renderColumns && g.renderColumns.call(b.tree, {type: "renderColumns"}, b), e)
            },
            nodeRenderStatus: function (b) {
            ...
            nodeSetExpanded: function (b, c, d) {
                function e(a) {
                    g(b.node, c), a ? c && b.options.autoScroll && !d.noAnimation && b.node.hasChildren() ? b.node.getLastChild().scrollIntoView(!0, {topNode: b.node}).always(function () {
                ...
                var f = new a.Deferred, h = a.extend({}, d, {noEvents: !0, noAnimation: !0});
    ...
    !function (a, b, c, d) {
        ...
        function f(a, b, c, d, e) {
            ...
            for (f = 0; b > f; f++)h.push(g + (f + 1) + " span.fancytree-title { padding-left: " + (f * c + d) + e + "; }");
        ...
        a.ui.fancytree.registerExtension({
            name: "wide",
            version: "0.0.3",
            options: {iconWidth: null, iconSpacing: null, levelOfs: null},
            treeCreate: function (b) {
                this._superApply(arguments), this.$container.addClass("fancytree-ext-wide");
                var c, d, h, i, j, k = b.options.wide, l = a("<li id='fancytreeTemp'><span class='fancytree-node'><span class='fancytree-icon' /><span class='fancytree-title' /></span><ul />").appendTo(b.tree.$container), m = l.find(".fancytree-icon"), n = l.find("ul"), o = k.iconSpacing || m.css("margin-left"), p = k.iconWidth || m.css("width"), q = k.levelOfs || n.css("padding-left");
                l.remove(), h = o.match(g)[2], o = parseFloat(o, 10), i = p.match(g)[2], p = parseFloat(p, 10), j = q.match(g)[2], h === i && j === i || a.error("iconWidth, iconSpacing, and levelOfs must have the same css measure unit"), this._local.measureUnit = i, this._local.levelOfs = parseFloat(q), this._local.lineOfs = (1 + (b.options.checkbox ? 1 : 0) + (b.options.icon === !1 ? 0 : 1)) * (p + o) + o, this._local.maxDepth = 10, c = this.$container.uniqueId().attr("id"), d = f(c, this._local.maxDepth, this._local.levelOfs, this._local.lineOfs, this._local.measureUnit), e(c, d)
            },
            treeDestroy: function (a) {
