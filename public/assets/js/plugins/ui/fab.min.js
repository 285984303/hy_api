...
$(function () {
    !function (a, b) {
        ...
        function f(a) {
            for (j = a.target; j && !j.getAttribute(n);)if (j = j.parentNode, !j)return;
            k = j.getAttribute(o) === p ? q : p, j.setAttribute(o, k)
        }

        var g, h, i, j, k, l = "click", m = "hover", n = "data-fab-toggle", o = "data-fab-state", p = "open", q = "closed", r = "fab-menu-btn";
