    ...
    return function e(n, t, r) {
        ...
        1: [function (e, n, t) {
            ...
            (function (t) {
                ...
                function r(e, n) {
                    function t(e) {
                        return -1 !== ce.containers.indexOf(e) || ue.isContainer(e)
                    }

                    function r(e) {
                        var n = e ? "remove" : "add";
                        o(oe, n, "mousedown", w), o(oe, n, "mouseup", Y)
                    }
                    ...
                    function p(e) {
                        var n = e ? "remove" : "add";
                        o(oe, n, "selectstart", b), o(oe, n, "click", b)
                    }
                    ...
                    function w(e) {
                        J = e.clientX, Q = e.clientY;
                        var n = 1 !== i(e) || e.metaKey || e.ctrlKey;
                        if (!n) {
                            var t = e.target, r = S(t);
                            r && (te = r, c(), "mousedown" === e.type && (v(t) ? t.focus() : e.preventDefault()))
                        }
                    }

                    function x(e) {
                        if (te) {
                            if (0 === i(e))return void Y({});
                            if (void 0 === e.clientX || e.clientX !== J || void 0 === e.clientY || e.clientY !== Q) {
                                if (ue.ignoreInputTextSelection) {
                                    var n = g("clientX", e), t = g("clientY", e), r = document.elementFromPoint(n, t);
                                    if (v(r))return
                                }
                                var o = te;
                                c(!0), p(), N(), O(o);
                                var a = u(V);
                                $ = g("pageX", e) - a.left, G = g("pageY", e) - a.top, E.add(ee || V, "gu-transit"), k(), A(e)
                            }
                        }
                    }

                    function S(e) {
                        if (!(ce.dragging && z || t(e))) {
                            for (var n = e; e.parentElement && t(e.parentElement) === !1;) {
                                if (ue.invalid(e, n))return;
                                if (e = e.parentElement, !e)return
                            }
                            var r = e.parentElement;
                            if (r && !ue.invalid(e, n)) {
                                var o = ue.moves(e, r, n, m(e));
                    ...
                    function O(e) {
                        F(e.item, e.source) && (ee = e.item.cloneNode(!0), ce.emit("cloned", ee, e.item, "copy")), H = e.source, V = e.item, W = Z = m(e.item), ce.dragging = !0, ce.emit("drag", V, H)
                    }
                    ...
                    function Y(e) {
                        if (X(), ce.dragging) {
                            var n = ee || V, t = g("clientX", e), r = g("clientY", e), o = a(z, t, r), i = R(o, t, r);
                            i && (ee && ue.copySortSource || !ee || i !== H) ? B(n, i) : ue.removeOnSpill ? P() : D()
                        }
                    }

                    function B(e, n) {
                        var t = e.parentElement;
                        ee && ue.copySortSource && n === H && t.removeChild(V), L(n) ? ce.emit("cancel", e, H, H) : ce.emit("drop", e, n, H, Z), I()
                    }

                    function P() {
                        if (ce.dragging) {
                            var e = ee || V, n = e.parentElement;
                            n && n.removeChild(e), ce.emit(ee ? "cancel" : "remove", e, n, H), I()
                        }
                    }

                    function D(e) {
                        if (ce.dragging) {
                            var n = arguments.length > 0 ? e : ue.revertOnSpill, t = ee || V, r = t.parentElement;
                            r === H && ee && r.removeChild(ee);
                            var o = L(r);
                            o === !1 && !ee && n && H.insertBefore(t, W), o || n ? ce.emit("cancel", t, H, H) : ce.emit("drop", t, r, H, Z), I()
                        }
                    }

                    function I() {
                        var e = ee || V;
                        X(), q(), e && E.rm(e, "gu-transit"), ne && clearTimeout(ne), ce.dragging = !1, ie && ce.emit("out", e, ie, H), ce.emit("dragend", e), H = V = ee = W = Z = ne = ie = null
                    }

                    function L(e, n) {
                        var t;
                        return t = void 0 !== n ? n : z ? Z : m(ee || V), e === H && t === W
                    }
                    ...
                    function R(e, n, r) {
                        function o() {
                            var o = t(i);
                            if (o === !1)return !1;
                            var u = U(i, e), c = _(i, u, n, r), a = L(i, c);
                            return a ? !0 : ue.accepts(V, i, H, c)
                        }
                    ...
                    function A(e) {
                        ...
                        if (z) {
                            e.preventDefault();
                            var o = g("clientX", e), i = g("clientY", e), u = o - $, c = i - G;
                            z.style.left = u + "px", z.style.top = c + "px";
                            var l = ee || V, f = a(z, o, i), d = R(f, o, i), s = null !== d && d !== ie;
                            if ((s || null === d) && (r(), ie = d, t()), d === H && ee && !ue.copySortSource)return void(l.parentElement && l.parentElement.removeChild(l));
                            var v, p = U(d, f);
                            if (null !== p)v = _(d, p, o, i); else {
                                if (ue.revertOnSpill !== !0 || ee)return void(ee && l.parentElement && l.parentElement.removeChild(l));
                                v = W, d = H
                            }
                            (null === v || v !== l && v !== m(l) && v !== Z) && (Z = v, d.insertBefore(l, v), ce.emit("shadow", l, d, H))
                        }
                    }
                    ...
                    function j(e) {
                        ce.dragging && E.add(e, "gu-hide")
                    }

                    function k() {
                        if (!z) {
                            var e = V.getBoundingClientRect();
                            z = V.cloneNode(!0), z.style.width = d(e) + "px", z.style.height = s(e) + "px", E.rm(z, "gu-transit"), E.add(z, "gu-mirror"), ue.mirrorContainer.appendChild(z), o(oe, "add", "mousemove", A), E.add(ue.mirrorContainer, "gu-unselectable"), ce.emit("cloned", z, V, "mirror")
                        }
                    }

                    function q() {
                        z && (E.rm(ue.mirrorContainer, "gu-unselectable"), o(oe, "remove", "mousemove", A), z.parentElement.removeChild(z), z = null)
                    }
                    ...
                    function _(e, n, t, r) {
                        ...
                        var c = "horizontal" === ue.direction, a = n !== e ? i() : o();
                        return a
                    }

                    function F(e, n) {
                        return "boolean" == typeof ue.copy ? ue.copy : ue.copy(e, n)
                    }

                    var K = arguments.length;
                    1 === K && Array.isArray(e) === !1 && (n = e, e = []);
                    var z, H, V, $, G, J, Q, W, Z, ee, ne, te, re = document.body, oe = document.documentElement, ie = null, ue = n || {};
                    ...
                    return ue.removeOnSpill === !0 && ce.on("over", M).on("out", j), r(), ce
                }
                ...
                function o(e, n, r, o) {
                    ...
                    t.navigator.msPointerEnabled && y[n](e, u[r], o), y[n](e, i[r], o), y[n](e, r, o)
                }
                ...
                function g(e, n) {
                    var t = p(n), r = {pageX: "clientX", pageY: "clientY"};
                    return e in r && !(e in t) && r[e] in t && (e = r[e]), t[e]
                }

                var h = e("contra/emitter"), y = e("crossvent"), E = e("./classes");
                n.exports = r
            ...
            (function (t) {
                ...
                var s = e("custom-event"), v = e("./eventmap"), m = t.document, p = r, g = i, h = [];
                t.addEventListener || (p = o, g = u), n.exports = {add: p, remove: g, fabricate: c}
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
