...
(function (e, d, a, f) {
    ...
    var c = function (j, h) {
        ...
        if (this.options.href) {
            ...
            k = k.replace(this.options.pageVariable, "(\\d+)");
        ...
        constructor: c, destroy: function () {
            ...
            this.$listContainer.find("li").each(function () {
                ...
                h.click(function (i) {
                    ...
                    g.show(parseInt(h.data("page")))
                })
            })
        }, makeHref: function (g) {
            return this.options.href ? this.makeText(this.options.href, g) : "#"
