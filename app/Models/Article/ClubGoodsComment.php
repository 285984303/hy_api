...
class ClubGoodsComment extends BaseModel {
	protected $table   = 'club_goods_comment';
	 ...
	 * @Des: 数据列表分页查询
	 * */
	public static function costSelectPage($school_id,$parms= array(),$orderfileds='id',$orderby='DESC'){
