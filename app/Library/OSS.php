...
class OSS
{
    ...
    public function __construct($isInternal = false)
    {
        ...
        $this->ossClient = AliyunOSS::boot(
            ...
            $this->networkType,
            $isInternal,
            \Config::get('oss.CONFIG.ACCESSID'),
            \Config::get('oss.CONFIG.ACCESSKEY')
        );
    }
    ...
    public static function objectExists($bucketName, $ossKey)
    {
        try {
            $oss = new OSS();
            $oss->ossClient->getObjectMeta($bucketName, $ossKey);
        } catch (\Exception $e) {
            if ($e->getMessage()) {
                return false;
            }
